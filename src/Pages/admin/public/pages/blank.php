...
// Query untuk mengambil data dari tabel_konser
$sql = "SELECT id_konser,nama_konser,tanggal_event, nama_lengkap, nomor_telepon, email, nomor_ktp, no_rek, masa_berlaku, kelas  FROM konser_table";
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              <thead class="text-xs text-gray-900 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th scope="col" class="px-6 py-3">MASA BERLAKU</th>
              ...
              <tbody>
                ...
                if ($result->num_rows > 0) {
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">' . htmlspecialchars($row['id_konser']) . '</th>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['nama_konser']) . '</td>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['tanggal_event']) . '</td>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['nama_lengkap']) . '</td>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['nomor_telepon']) . '</td>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['email']) . '</td>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['nomor_ktp']) . '</td>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['no_rek']) . '</td>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['masa_berlaku']) . '</td>';
                    echo '<td class="px-6 py-4">' . htmlspecialchars($row['kelas']) . '</td>';
                    echo '</tr>';
                  }
                } else {
                  echo '<tr class="bg-white dark:bg-gray-800"><td colspan="10" class="px-6 py-4 text-center">No records found</td></tr>';
                }
                ?>
              </tbody>
            </table>
