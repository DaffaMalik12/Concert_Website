...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $nama_konser = "Soora Music Festival!";
    $tanggal_event = "Minggu,  9 Juni 2024";
    $nama_lengkap = $_POST["nama_lengkap"];
    $nomor_telepon = $_POST["nomor_telepon"];
    $email = $_POST["email"];
    $nomor_ktp = $_POST["nomor_ktp"];
    $no_rek = $_POST["nomor_rekening"];
    $masa_berlaku = "9 Juni 2024";
    $kelas = "REGULER 1";
    // Koneksi ke database
...
<body>
    <div class="container mx-auto">
        ...
        <section>
            <div class="pembungkus-gambar">
                <img style="height: 500px;" src="../../asset/img/Soora-Music-Festival-resize.jpg" alt="" class="  blur-sm mx-auto w-full relative -z-0">
                <img style="margin-top: -500px; height: 500px;  " src="../../asset/img/Soora-Music-Festival-resize.jpg" alt=" " class="relative z-10 w-11/12 mx-auto ">
            </div>
        </section>
        <!-- Akhir Jumbotron -->
        <!-- Artikel -->
        <article class="flex">
            <h1 style="width: 1200px;" class="font-bold text-5xl p-10">Soora Music Festival!</h1>
            <div class="pembungkus flex flex-col lg:ml-12">
                <p class="text-xl font-semibold p-10">Mulai Dari</p>
                <p class="text-2xl font-semibold text-red-600 lg:-mt-9 mb-3">IDR. 200.000</p>
                <!-- Button Kedua  -->
        ...
        <div class="pembungkus-lokasi flex">
            ...
            <p class="lg:pl-2 text-lg font-medium">Bandung</p>
        </div>
        <div class="pembungkus-kalender flex lg:mt-4">
            ...
            <p class="lg:pl-2 text-lg font-medium">9 Juni 2024</p>
        </div>
        <!-- Akhir Artikel -->
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                ...
                                <div class="relative backdrop-blur-sm bg-white/30  rounded-lg shadow ">
                                    ...
                                    <div class="p-4 md:p-5">
                                        ...
                                        <form id="paymentForm" action="Soora.php" method="POST">
    ...
    <script src="../../script/LogicSoora.js"></script>
        ...
        function submitForm() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = '../display/displaySoora.php';
                },
