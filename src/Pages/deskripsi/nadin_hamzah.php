...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $nama_konser = "Market East Festival! Nadin Amizah";
    $tanggal_event = "Minggu, 2 JUNI 2024";
...
<body>
    <div class="container mx-auto">
        ...
        <section>
            <div class="pembungkus-gambar">
                <img style="height: 500px;" src="../../asset/img/Market-East-Festival.jpg" alt="" class="  blur-sm mx-auto w-full relative -z-0">
                <img style="margin-top: -500px; height: 500px;  " src="../../asset/img/Market-East-Festival.jpg" alt=" " class="relative z-10 w-11/12 mx-auto ">
            </div>
        </section>
        <!-- Akhir Jumbotron -->
        <!-- Artikel -->
        <article class="flex">
            <h1 style="width: 1200px;" class="font-bold text-5xl p-10">Market East Festival! Nadin Amizah</h1>
            <div class="pembungkus flex flex-col lg:ml-12">
                <p class="text-xl font-semibold p-10">Mulai Dari</p>
                <p class="text-2xl font-semibold text-red-600 lg:-mt-9 mb-3">IDR. 850.000</p>
                <!-- Button Kedua  -->
        ...
        <div class="pembungkus-lokasi flex">
            ...
            <p class="lg:pl-2 text-lg font-medium">Ternate Indonesia</p>
        </div>
        <div class="pembungkus-kalender flex lg:mt-4">
            ...
            <p class="lg:pl-2 text-lg font-medium">2 Juni 2024</p>
        </div>
        <!-- Akhir Artikel -->
            ...
            <div class="pembungkus-card flex items-center justify-center lg:mt-10 flex-wrap lg:gap-10">
                    ...
                    <form action="nadin_hamzah.php" method="POST">
                        ...
                        <div class="border-t pt-4">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <span class="text-red-600 font-semibold" id="totalPrice">Rp. 850.000</span>
                            </div>
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                ...
                                <div class="relative backdrop-blur-sm bg-white/30  rounded-lg shadow ">
                                    ...
                                    <div class="p-4 md:p-5">
                                        ...
                                        <form id="paymentForm" action="nadin_hamzah.php" method="POST">
                                            <button onclick="submitForm();" class="w-full mt-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Bayar</button>
                                        </form>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 w-80">
                    ...
                    <div class="text-gray-700 mb-4">
                        <div class="flex justify-between">
                            <span>Tanggal Event</span>
                            <span>Minggu, 2 Juni</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Masa berlaku:</span>
                            <span>2 Juni 2024</span>
                        </div>
                    </div>
                    <div class="flex items-center justify-between mb-4">
                        <span class="text-gray-700">Jumlah Tiket</span>
                ...
                <!-- Card 3 -->
                <div class="bg-white rounded-lg shadow-md p-6 w-80">
                    <h2 class="text-lg font-semibold mb-2">REGULER 4</h2>
                    <div class="text-gray-700 mb-4">
                        <div class="flex justify-between">
                            <span>Tanggal Event</span>
    ...
    <script src="../../script/FunctionIINCRDECRnadin.js"></script>
    <script src="../../script/formRadio.js"></script>
    <script>
        function submitForm() {
            // Proses submit form menggunakan AJAX
            $.ajax({
                // type: 'POST',
                // url: 'nadin_hamzah.php',
                data: $('#paymentForm').serialize(),
                success: function(response) {
                    // Logika tambahan setelah berhasil submit form
                    alert('Pembayaran Berhasil');
                    window.location.href = '../display/displaynadin.php';
                },
