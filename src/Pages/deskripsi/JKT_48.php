...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $nama_konser = "JKT48 INDONESIA MILENIAL & GE..";
    $tanggal_event = "Rabu26 November";
    $nama_lengkap = $_POST["nama_lengkap"];
    $nomor_telepon = $_POST["nomor_telepon"];
    $email = $_POST["email"];
    $nomor_ktp = $_POST["nomor_ktp"];
    $no_rek = $_POST["nomor_rekening"];
    $masa_berlaku = "26 November";
    $kelas = "REGULER 1";
    // Koneksi ke database
...
<body>
    <div class="container mx-auto">
        ...
        <!-- Artikel -->
        <article class="flex">
            <h1 style="width: 1200px;" class="font-bold text-5xl p-10">JKT48 INDONESIA MILENIAL & GE..</h1>
            <div class="pembungkus flex flex-col lg:ml-12">
                <p class="text-xl font-semibold p-10">Mulai Dari</p>
                <p class="text-2xl font-semibold text-red-600 lg:-mt-9 mb-3">IDR. 450.000</p>
                <!-- Button Kedua  -->
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                ...
                                <div class="relative backdrop-blur-sm bg-white/30  rounded-lg shadow ">
                                    ...
                                    <div class="p-4 md:p-5">
                                        ...
                                        <form id="paymentForm" action="JKT_48.php" method="POST">
    ...
    <script src="../../script/LogicJKT.js"></script>
        ...
        function submitForm() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = '../display/displayJKT.php';
                },
